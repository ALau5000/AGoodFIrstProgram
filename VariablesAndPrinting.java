public class VariablesAndPrinting {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("When " + (hisName) + " saw his mark, he was " + (hisFeeling) + " because the number " + (hisMark) + " reminded him of how many times he was punched in the face when was a little boy.");
