public class NumbersAndMath {
    ...
    public static void main(String[] args) {
        System.out.println("I will count the chicken nuggets I will be consuming:");
        System.out.println("*munch munch munch*    " + (70 + 123) + " nuggets down!");
        ...
        System.out.println("Well, is 88 greater or equal to 888. I think it's equal since both numbers have 2 eights!:)");
        System.out.println("I think you need to go back to kindergarten kiddo cause once again, it's " + (88 >= 888) + ". It's not even greater either...");
    }
}
